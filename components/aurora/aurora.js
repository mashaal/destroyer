...
Asset = (function(_super) {
  ...
  Asset.fromURL = function(url, length) {
    return new Asset(new HTTPSource(url, length));
  };
...
Player = (function(_super) {
  ...
  Player.fromURL = function(url, length) {
    return new Player(Asset.fromURL(url, length));
  };
